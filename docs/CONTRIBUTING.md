# Contributing 
Welcome, and thank you for your interest in helping to improve and accelerate/ease the adoption of arg-min-dl (Deep Learning Architectures for Argument Mining Tasks).
...
Before you create a new issue, please do a search in [open issues](https://github.com/argrecsys/arg-min-dl/issues) to see if the issue or feature request has already been filed.
...
# Thank You!
Your contributions to arg-min-dl, large or small, make great projects like this possible. Thank you for taking the time to contribute!
